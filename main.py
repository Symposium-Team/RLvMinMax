...
if __name__ == '__main__':
    ...
    plt.plot(episodes, RL1scores, label='Untrained Q-Learning(alpha=0.9, epsilon=0.8')
    plt.plot(episodes, RL2scores, label='Trained Q-Learning(alpha=0.9, epsilon=0.8')
